...
3. These simulations are typically done with generators for which an on-the-fly analysis for a specific observable is difficult within our frameworks. On-the-fly Pythia can be easily done via `alian` or `pyjetty`.
